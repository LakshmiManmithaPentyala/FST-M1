...
public class Activity_9 {
	...
	public void activity_9() throws InterruptedException {
		...
		for(int i=1;i<11;i++) {////tr[@class='oddListRowS1' or @class= 'evenListRowS1']/td[3]
			String name = driver.findElement(By.xpath("(//tr[@class='oddListRowS1' or @class= 'evenListRowS1']/td[3])["+i+"]")).getText();
			String user = driver.findElement(By.xpath("(//tr[@class='oddListRowS1' or @class= 'evenListRowS1']/td[8])["+i+"]")).getText();
